# Projects for the Operating Systems(EOPSY) Course
...
Scheduling algorithms and techniques, specifically the First-Come First-Served(FCFS) Batch (Non preemptive) scheduling.

## Task 4

Memory Management Schemes, Paging, Mapping, Page Replacement Algorithms, etc.